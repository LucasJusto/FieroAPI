...
export class QuickChallengeTables1658344687057 implements MigrationInterface {
    name = 'QuickChallengeTables1658344687057'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "team_user" ADD CONSTRAINT "FK_ed60beadf0e6dffb2b9a5d164e4" FOREIGN KEY ("team_id") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_b342fa0864f10bd006259ae3412" FOREIGN KEY ("quickChallenge_id") REFERENCES "quick_challenge"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
